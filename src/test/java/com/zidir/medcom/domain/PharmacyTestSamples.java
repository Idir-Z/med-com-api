...
public class PharmacyTestSamples {
    ...
    public static Pharmacy getPharmacySample1() {
        return new Pharmacy().id(1L).name("name1").address("address1").email("email1").phone("phone1").website("website1");
    }

    public static Pharmacy getPharmacySample2() {
        return new Pharmacy().id(2L).name("name2").address("address2").email("email2").phone("phone2").website("website2");
    }
