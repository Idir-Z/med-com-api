...
import static com.zidir.medcom.domain.ProductAsserts.*;
...
import com.zidir.medcom.repository.ProductRepository;
import com.zidir.medcom.service.dto.ProductDTO;
import com.zidir.medcom.service.mapper.ProductMapper;
...
class ProductResourceIT {
    ...
    public static Product createEntity() {
        return new Product().name(DEFAULT_NAME).code(DEFAULT_CODE).officialUrl(DEFAULT_OFFICIAL_URL);
    }
    ...
    public static Product createUpdatedEntity() {
        return new Product().name(UPDATED_NAME).code(UPDATED_CODE).officialUrl(UPDATED_OFFICIAL_URL);
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).code(UPDATED_CODE).officialUrl(UPDATED_OFFICIAL_URL);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.officialUrl(UPDATED_OFFICIAL_URL);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).code(UPDATED_CODE).officialUrl(UPDATED_OFFICIAL_URL);
